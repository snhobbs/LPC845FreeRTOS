...
Running the demo
================
The log below shows the output of the SPI transfer using DMA master driver example in the terminal window:
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
This is SPI dma transfer master example!
To make sure the transfer work successffully, please start the slave board first!
